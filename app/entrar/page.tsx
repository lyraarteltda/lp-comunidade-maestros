              ...
              <div className="glass-card-featured rounded-2xl p-8 sm:p-10 noise-bg">
                <div className="relative z-10">
                  ...
                  <p className="text-text-secondary leading-relaxed mb-6">
                    Responda para liberar seu acesso à comunidade. É rápido —
                    leva menos de 1 minuto.
                  </p>

                  <div className="inline-flex items-center gap-2 px-5 py-2.5 rounded-full bg-emerald-500/[0.1] border border-emerald-500/20">
                  ...
                  <p className="text-text-muted text-xs mt-6">
                    Não recebeu? Verifique se o número está correto ou entre em
                    contato pelo{" "}
                    <a
