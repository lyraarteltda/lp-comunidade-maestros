...
function buildFaqs(price: number) {
  return [
    ...
    },
    {
      ...
      answer: "Sim. Sem taxa de cancelamento, sem compromisso, sem multa. Quando o conteúdo da semana já vale mais que a mensalidade, as pessoas ficam. Você não vai cancelar porque alguém travou o botão — vai ficar porque toda semana tem live nova, sistema novo, ferramenta nova.",
    },
    {
